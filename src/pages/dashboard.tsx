...
import { useRoqPlatformUserProfiles, useStaffMemberCount, useDoctorCount, useNurseCount } from 'lib/roq';

import { NurseListPage as ShowCaseList } from 'pages/nurses';

function DashboardPage() {
  const { session } = useSession();

  const staffMemberStat = useStaffMemberCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`nurses`} passHref legacyBehavior>
                  <Button
